...
package com.android.settings.flex.activities;

import android.app.Activity;
import android.os.Bundle;
import android.util.Log;

import com.android.settings.flex.util.CMDProcessor;
import com.android.settings.flex.util.CMDProcessor.CommandResult;
import com.android.settings.flex.util.Helpers;

public class FlushMemory extends Activity {

  private static final String TAG = "flexMemFlusher";
